...
public class MatFloat {
    ...
    public static MatFloat rand(int row, int col, float min, float max){
        return new MatFloat(row, col).rand(min, max);
    }
    ...
    public MatFloat add(int r, int c, float val){
        mat[r][c] += val;
        return this;
    }
    ...
    public MatFloat sub(int r, int c, float val){
        mat[r][c] -= val;
        return this;
    }
    ...
    public MatFloat mul(int r, int c, float val){
        mat[r][c] *= val;
        return this;
    }
